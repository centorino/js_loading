...
showLoading = ->
  $('#loading_js_wrapper').show()
  
hideLoading = ->
  $('#loading_js_wrapper').fadeOut()
  
_create_loading_html = ->
  return if $('#loading_js_wrapper').length > 0
  ...
  wrapper = $('<div/>').attr('id', 'loading_js_wrapper')
...
@LoadingJs = {initialize, showLoading, hideLoading}
